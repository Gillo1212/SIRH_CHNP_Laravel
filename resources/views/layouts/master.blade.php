...
<head>
    ...
    {{-- Système de Thèmes SIRH --}}
    <link rel="stylesheet" href="{{ asset('css/themes.css') }}">

    {{-- Vite compiled assets (Tailwind utilities) --}}
    ...
    <style>
        ...
        /* ═════════════════════════════════════════════════════════════════════
           PANEL - Conteneur générique (utilisé dans toutes les vues)
           ═════════════════════════════════════════════════════════════════════ */
        .panel {
            background-color: #ffffff;
...
>
    ...
    {{-- Composant Alpine.js : themeManager (requis par header-pro) --}}
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('themeManager', () => ({
                currentTheme: localStorage.getItem('sirh_theme') || 'system',
                ...
                getLabel() {
                    ...
                    return labels[this.currentTheme] || 'Thème';
                },

                getIcon() {
                    const icons = { light: 'fa-sun', dark: 'fa-moon', system: 'fa-desktop' };
                    return icons[this.currentTheme] || 'fa-desktop';
                }
            }));
        });
    </script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        Swal.fire({
            ...
            position: 'top-end',
            icon: '{{ $toastType }}',
            html: `{!! addslashes(strip_tags($toastMsg, '<strong><code><b>')) !!}`,
