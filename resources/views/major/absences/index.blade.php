...
<div class="container-fluid px-4 py-4">
    ...
    <div class="bg-white rounded shadow-sm p-3 mb-4">
        <form method="GET" action="{{ route('major.absences.index') }}">
            <div class="d-flex align-items-center gap-2 flex-wrap">
                ...
                @if(request()->anyFilled(['mois', 'annee', 'type', 'agent']))
                    <a href="{{ route('major.absences.index') }}" class="btn btn-outline-secondary" title="Réinitialiser">
                        ...
                        @forelse($absences as $absence)
                            ...
                            <tr class="abs-row" style="border-bottom:1px solid #F3F4F6;">
                                ...
                                <td class="py-3 border-0 text-end pe-4">
                                    <a href="{{ route('major.absences.show', $absence->id_absence) }}"
...
<div class="modal fade" id="modal-create-absence" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0" style="border-radius:16px;overflow:hidden;">
            ...
            <form action="{{ route('major.absences.store') }}" method="POST">
                @csrf
                <div class="modal-body p-4">
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-12 col-md-5">
                            ...
                            <input type="date" name="date_absence" value="{{ today()->format('Y-m-d') }}"
                    ...
                    <div class="mb-3">
                        <div class="form-check p-3" style="background:#F8FAFC;border-radius:8px;border:1px solid #E5E7EB;">
                            <input class="form-check-input" type="checkbox" name="justifie" id="justifieMajor" value="1">
                            <label class="form-check-label small fw-600" for="justifieMajor">
                                Absence justifiée
