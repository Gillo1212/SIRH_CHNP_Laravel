            ...
            <div class="form-card card border-0 shadow-sm mb-4">
                ...
                <form action="{{ route('agent.conges.store') }}" method="POST" id="formConge">
                    ...
                    <div class="d-flex gap-3">
                        <button type="submit" class="btn btn-primary d-flex align-items-center gap-2" style="background:#0A4D8C;border:none;border-radius:8px;padding:10px 24px;">
                            <i class="fas fa-paper-plane"></i> Soumettre la demande
                        </button>
                        <a href="{{ route('agent.conges.index') }}" class="btn d-flex align-items-center gap-2" style="background:var(--theme-bg-secondary);border:1px solid var(--theme-border);border-radius:8px;padding:10px 20px;color:var(--theme-text);">
